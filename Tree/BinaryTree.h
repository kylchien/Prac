...
/*
content source: http://articles.leetcode.com/2010/09/how-to-pretty-print-binary-tree.html
*/
...
struct BinaryTree {
	...
	int data;
	BinaryTree(int val) : left(nullptr), right(nullptr), data(val) { }
	~BinaryTree() {}
	BinaryTree(int val, BinaryTree* l, BinaryTree* r):left(l), right(r), data(val){}
	BinaryTree(int val, int l, int r) {
		data = val;
